This is a minor update. In this version, I fixed some issues and included an internal dataset that can be used to speed up the package's main function, get_gender.
